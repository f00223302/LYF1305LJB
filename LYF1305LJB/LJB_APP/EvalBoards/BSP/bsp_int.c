...
void  BSP_IntHandlerDMA1_STREAM0       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM0);        }
void  BSP_IntHandlerDMA1_STREAM1       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM1);        }
void  BSP_IntHandlerDMA1_STREAM2       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM2);        }
void  BSP_IntHandlerDMA1_STREAM3       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM3);        }
void  BSP_IntHandlerDMA1_STREAM4       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM4);        }
void  BSP_IntHandlerDMA1_STREAM5       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM5);        }
void  BSP_IntHandlerDMA1_STREAM6       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_STREAM6);        }
...
void  BSP_IntHandlerDMA2_STREAM0       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM0);        }
void  BSP_IntHandlerDMA2_STREAM1       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM1);        }
void  BSP_IntHandlerDMA2_STREAM2       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM2);        }
void  BSP_IntHandlerDMA2_STREAM3       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM3);        }
void  BSP_IntHandlerDMA2_STREAM4       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM4);        }
...
void  BSP_IntHandlerDMA2_STREAM5       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM5);        }
void  BSP_IntHandlerDMA2_STREAM6       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM6);        }
void  BSP_IntHandlerDMA2_STREAM7       (void)  { BSP_IntHandler(BSP_INT_ID_DMA2_STREAM7);        }
