...
///从 FLASH SECTOR 5 开始 0x10000
#define VECT_TAB_OFFSET  0x10000L /*!< Vector Table base offset field. 
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    FLASH->ACR = FLASH_ACR_PRFTEN | FLASH_ACR_ICEN | FLASH_ACR_DCEN | FLASH_ACR_LATENCY_3WS; // 原来为 FLASH_ACR_LATENCY_7WS   根据张工的要求降频 120M->60M
