...
;//////////////////////////////////////////////////////////////////////////////////////////////////////////
;	2013.08.20:
;		由于原中断ID号定义中，DMA 相关的中断命名为channel，容易和通道混淆，实际是对应 STREAM 号。
...
;                IMPORT  BSP_IntHandlerDMA1_CH7
                IMPORT  BSP_IntHandlerDMA1_STREAM0
                IMPORT  BSP_IntHandlerDMA1_STREAM1
                IMPORT  BSP_IntHandlerDMA1_STREAM2
                IMPORT  BSP_IntHandlerDMA1_STREAM3
                IMPORT  BSP_IntHandlerDMA1_STREAM4
                IMPORT  BSP_IntHandlerDMA1_STREAM5
                IMPORT  BSP_IntHandlerDMA1_STREAM6
...
;                IMPORT  BSP_IntHandlerDMA2_CH5
                IMPORT  BSP_IntHandlerDMA2_STREAM0
                IMPORT  BSP_IntHandlerDMA2_STREAM1
                IMPORT  BSP_IntHandlerDMA2_STREAM2
                IMPORT  BSP_IntHandlerDMA2_STREAM3
                IMPORT  BSP_IntHandlerDMA2_STREAM4
...
;                IMPORT  BSP_IntHandlerDMA2_CH8
                IMPORT  BSP_IntHandlerDMA2_STREAM5
                IMPORT  BSP_IntHandlerDMA2_STREAM6
                IMPORT  BSP_IntHandlerDMA2_STREAM7
...
;                DCD     BSP_IntHandlerDMA1_CH7              ;/* 33, INTISR[ 17]  DMA Channel7 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM0          ;/* 27, INTISR[ 11]  DMA Channel1 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM1          ;/* 28, INTISR[ 12]  DMA Channel2 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM2          ;/* 29, INTISR[ 13]  DMA Channel3 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM3          ;/* 30, INTISR[ 14]  DMA Channel4 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM4          ;/* 31, INTISR[ 15]  DMA Channel5 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM5          ;/* 32, INTISR[ 16]  DMA Channel6 Global Interrupt.      */
                DCD     BSP_IntHandlerDMA1_STREAM6          ;/* 33, INTISR[ 17]  DMA Channel7 Global Interrupt.      */				
...
;                DCD     BSP_IntHandlerDMA2_CH5              ;/* 76, INTISR[ 60]  DMA2 Channel 5 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM0          ;/* 72, INTISR[ 56]  DMA2 Channel 1 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM1          ;/* 73, INTISR[ 57]  DMA2 Channel 2 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM2          ;/* 74, INTISR[ 58]  DMA2 Channel 3 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM3          ;/* 75, INTISR[ 59]  DMA2 Channel 4 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM4          ;/* 76, INTISR[ 60]  DMA2 Channel 5 global Interrupt.    */
...
;                DCD     BSP_IntHandlerDMA2_CH8              ;/* 86, INTISR[ 70]  DMA2 Channel 8 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM5          ;/* 84, INTISR[ 68]  DMA2 Channel 7 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM6          ;/* 95, INTISR[ 69]  DMA2 Channel 7 global Interrupt.    */
                DCD     BSP_IntHandlerDMA2_STREAM7          ;/* 06, INTISR[ 70]  DMA2 Channel 8 global Interrupt.    */
