...
void BSP_DAC_Init(uint16_t *buf)
{
	...
	BSP_DAC_GPIOConfig(((uint16_t)0x0010));
	BSP_DAC_Config(((uint32_t)0x00000000));


	BSP_DAC_DMAConfig(((uint32_t)0x00000000), ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x0E000000), (uint32_t)((((uint32_t)0x40000000) + 0x7400) + 0x08), buf);


#line 106 "..\\BSP\\bsp_DAC.c"



	
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x00000010), ENABLE);
	DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x20000800));
	
	BSP_IntVectSet(16, BSP_DAC1_DMA_ISRHandler);
    BSP_IntEn(16);



  	 
	DAC_Cmd(((uint32_t)0x00000000), ENABLE);


	
	DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), DISABLE);
...
void BSP_DAC_Start(uint16_t *buf, uint16_t len)
{
	if (BSP_Info.Error & 0x00000008)
		return;
	

	
	if (DMA_GetCmdStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088))) == DISABLE){
		...
		DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), &DAC_DMA_InitStructure);
		 
		DAC_DMACmd(((uint32_t)0x00000000), ENABLE);		
		
		DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ENABLE); 
...
void BSP_DAC_GPIOConfig(uint16_t pins)
{
	GPIO_InitTypeDef GPIO_InitStructure;
  	...
  	RCC_AHB1PeriphClockCmd(((uint32_t)0x00200000) | ((uint32_t)0x00000001), ENABLE);
...
void BSP_DAC_Config(uint32_t dac_ch)
{
	...
	DAC_InitStructure.DAC_Trigger = ((uint32_t)0x00000004);
	DAC_InitStructure.DAC_WaveGeneration = ((uint32_t)0x00000000);
	DAC_InitStructure.DAC_OutputBuffer = ((uint32_t)0x00000000);
	DAC_InitStructure.DAC_LFSRUnmask_TriangleAmplitude = ((uint32_t)0x00000900);
...
void BSP_DAC_DMAConfig(uint32_t dac_ch, DMA_Stream_TypeDef *stream, uint32_t dma_ch, uint32_t data_addr, uint16_t *buf)
{
	...
	DAC_DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&(buf[0]);
	DAC_DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000040);
	DAC_DMA_InitStructure.DMA_BufferSize = 0;
	DAC_DMA_InitStructure.DMA_PeripheralInc = ((uint32_t)0x00000000);
	DAC_DMA_InitStructure.DMA_MemoryInc = ((uint32_t)0x00000400);
	DAC_DMA_InitStructure.DMA_PeripheralDataSize = ((uint32_t)0x00000800);
	DAC_DMA_InitStructure.DMA_MemoryDataSize = ((uint32_t)0x00002000);
	DAC_DMA_InitStructure.DMA_Mode = ((uint32_t)0x00000000);
	DAC_DMA_InitStructure.DMA_Priority = ((uint32_t)0x00020000);
	DAC_DMA_InitStructure.DMA_FIFOMode = ((uint32_t)0x00000000);         
	DAC_DMA_InitStructure.DMA_FIFOThreshold = ((uint32_t)0x00000001);
	DAC_DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000000);
	DAC_DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
...
void BSP_DAC1_DMA_ISRHandler(void)
{
	...
	if (((((0x0800u) != 0u) && (((status) & (0x0800u)) == (0x0800u))) ? (1u) : (0u ))){

		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x20008800));
		
		if (BSP_Info.DACCallBack)
			BSP_Info.DACCallBack(0, 0);
	}

	
	if (((((0x0200u) != 0u) && (((status) & (0x0200u)) == (0x0200u))) ? (1u) : (0u )))
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x20002200));	

	
	if (((((0x40u) != 0u) && (((status) & (0x40u)) == (0x40u))) ? (1u) : (0u )))
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0xA0000040));	
}
