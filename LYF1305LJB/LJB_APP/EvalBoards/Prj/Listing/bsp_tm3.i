...
#line 13 "..\\BSP\\bsp_tm3.c"
#line 14 "..\\BSP\\bsp_tm3.c"
...
void BSP_Tm3_Init(void)
{
	...
	uint16_t PrescalerValue;
  	...
  	TIM_TimeBaseStructure.TIM_Period = 6000000L / 12500L - 1;
	...
	BSP_IntVectSet(29, BSP_TIM3_ISRHandler);
    BSP_IntEn(29);
}
	...
	if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((uint16_t)0x0001)) != RESET)
  	{
		...
		if (BSP_Info.Tm3CallBack)
			BSP_Info.Tm3CallBack(0, 0);
#line 95 "..\\BSP\\bsp_tm3.c"
	}
}
