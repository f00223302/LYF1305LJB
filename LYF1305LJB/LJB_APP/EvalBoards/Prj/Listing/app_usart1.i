...
#line 19 "..\\App\\app_usart1.c"
#line 20 "..\\App\\app_usart1.c"
#line 21 "..\\App\\app_usart1.c"
...
uint8_t		Usart1RxBuf[((uint16_t)1 << 10)];
uint8_t		Usart1TxBuf[((uint16_t)1 << 10)];

uint8_t		_tmpRxBuf1[((uint16_t)1 << 10)];
uint8_t		_tmpTxBuf1[((uint16_t)1 << 10)];
DATA_STRUCT _RxInfo1;
DATA_STRUCT _TxInfo1;

volatile uint8_t _Order = 0;
volatile uint8_t _AckOrder = 0;
...
#line 604 "..\\App\\app_usart1.c"


#line 710 "..\\App\\app_usart1.c"
...
void ReadBoardWorkInfo(void)
{
	...
	for(i = 0; i < 10; i++)
	{
		_TxInfo1.data[i] = D110VADBuf[4][i];
	}

	_TxInfo1.data[10] = buf[0];
	_TxInfo1.data[11] = D110VADBuf[0][D110VCnt[0]];
	_TxInfo1.data[12] = buf[1];
	_TxInfo1.data[13] = D110VADBuf[1][D110VCnt[1]];
	_TxInfo1.data[14] = buf[2];
	_TxInfo1.data[15] = D110VADBuf[2][D110VCnt[2]];
	_TxInfo1.data[16] = buf[3];
	_TxInfo1.data[17] = D110VADBuf[3][D110VCnt[3]];
}
...
void ReportPowOffData(int ClearData)
{
    ...
    totalCnt=RecInfo.TotNewRec>(31)?(31):RecInfo.TotNewRec;
