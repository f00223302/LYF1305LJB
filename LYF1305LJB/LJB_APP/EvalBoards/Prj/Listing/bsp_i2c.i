...
#line 78 "..\\BSP\\bsp_i2c.c"



#line 82 "..\\BSP\\bsp_i2c.c"
...
volatile uint32_t  sEETimeout = ((uint32_t)(10 * ((uint32_t)0x1000)));   
volatile uint16_t* sEEDataReadPointer;   
volatile uint16_t* sEEDataWritePointer;  
volatile uint16_t  sEEDataNum;
...
{	
	...
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRH = ((uint16_t)0x0004);};
	sEE_WriteBuffer(buf, WriteAddr, NumByteToWrite);
	 
	err = sEE_WaitEepromStandbyState();  
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRL = ((uint16_t)0x0004);};
...
{  
	...
	sEETimeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
	...
	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), sEEAddress, ((uint8_t)0x00));
	...
	I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ReadAddr);  

#line 324 "..\\BSP\\bsp_i2c.c"
	...
	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), sEEAddress, ((uint8_t)0x01));  
	...
	if ((uint16_t)(*NumByteToRead) < 2)
	{
		...
		sEETimeout = ((uint32_t)0x1000);
		while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x10000002)) == RESET)
		{
			if((sEETimeout--) == 0) return sEE_TIMEOUT_UserCallback();
		}     
		...
		*pBuffer = I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)));
	...
	else 
	{
		...
		sEE_LowLevel_DMAConfig((uint32_t)pBuffer, (uint16_t)(*NumByteToRead), 1);
...
{ 
	...
	I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), WriteAddr);
  
#line 495 "..\\BSP\\bsp_i2c.c"
	...
	sEE_LowLevel_DMAConfig((uint32_t)pBuffer, (uint8_t)(*NumByteToWrite), 0);
...
#line 915 "..\\BSP\\bsp_i2c.c"
	...
	BSP_IntVectSet(17, sEE_I2C_DMA_TX_IRQHandler);
    BSP_IntEn(17);
	

	 
	BSP_IntVectSet(11, sEE_I2C_DMA_RX_IRQHandler);
    BSP_IntEn(11);
...
void sEE_I2C_DMA_TX_IRQHandler(void)
{
	...
	if(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0)), ((uint32_t)0x20200000)) != RESET)
	{  
...
void sEE_I2C_DMA_RX_IRQHandler(void)
{
	...
	if(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010)), ((uint32_t)0x10000020)) != RESET)
	{      
