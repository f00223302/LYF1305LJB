...
#line 28 "..\\..\\uCOS-II\\Source\\os_task.c"
                         ...
                         INT8U  newprio)
{
 ...
 
#line 86 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 230 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 360 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 460 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 601 "..\\..\\uCOS-II\\Source\\os_task.c"
    if (prio == 0xFFu) {                                  
        {cpu_sr = OS_CPU_SR_Save();};                                     
...
#line 666 "..\\..\\uCOS-II\\Source\\os_task.c"

#line 679 "..\\..\\uCOS-II\\Source\\os_task.c"
    if (OSIntNesting > 0u) {                               
        *perr = 17u;
        return (0u);
    }
...
#line 747 "..\\..\\uCOS-II\\Source\\os_task.c"

#line 760 "..\\..\\uCOS-II\\Source\\os_task.c"
    if (OSIntNesting > 0u) {                          
        *perr = 18u;
        return;
    }
...
#line 895 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 978 "..\\..\\uCOS-II\\Source\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                                  
        prio = OSTCBCur->OSTCBPrio;
        self = 1u;
...
#line 1050 "..\\..\\uCOS-II\\Source\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        prio = OSTCBCur->OSTCBPrio;
    }
...
#line 1115 "..\\..\\uCOS-II\\Source\\os_task.c"

#line 1128 "..\\..\\uCOS-II\\Source\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        ptcb = OSTCBCur;
    } else {
...
#line 1174 "..\\..\\uCOS-II\\Source\\os_task.c"
...
#line 1237 "..\\..\\uCOS-II\\Source\\os_task.c"

#line 1250 "..\\..\\uCOS-II\\Source\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        ptcb = OSTCBCur;
    } else {
...
#line 1332 "..\\..\\uCOS-II\\Source\\os_task.c"
        }
    }
}
