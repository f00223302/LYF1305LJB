...
#line 13 "..\\BSP\\bsp_tm6.c"
#line 14 "..\\BSP\\bsp_tm6.c"
...
void BSP_Tm6_Init(void)
{
	...
	uint16_t PrescalerValue;
  	...
  	PrescalerValue = (uint16_t) ((SystemCoreClock / 2) / 6000000L) - 1;

  	 
  	TIM_TimeBaseStructure.TIM_Period = 6000000L / 12000L - 1;
  	...
  	TIM_PrescalerConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)), PrescalerValue, ((uint16_t)0x0001));


	 
  	TIM_SelectOutputTrigger(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)), ((uint16_t)0x0020));
