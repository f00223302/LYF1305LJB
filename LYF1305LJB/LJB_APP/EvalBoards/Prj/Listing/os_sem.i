...
#line 28 "..\\..\\uCOS-II\\Source\\os_sem.c"
...
#line 111 "..\\..\\uCOS-II\\Source\\os_sem.c"
...
#line 192 "..\\..\\uCOS-II\\Source\\os_sem.c"

#line 199 "..\\..\\uCOS-II\\Source\\os_sem.c"
    if (pevent->OSEventType != 3u) {         
        *perr = 1u;
        return (pevent);
    }
...
#line 311 "..\\..\\uCOS-II\\Source\\os_sem.c"

#line 318 "..\\..\\uCOS-II\\Source\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return;
    }
...
#line 421 "..\\..\\uCOS-II\\Source\\os_sem.c"

#line 428 "..\\..\\uCOS-II\\Source\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return (0u);
    }
...
#line 553 "..\\..\\uCOS-II\\Source\\os_sem.c"
    if (pevent->OSEventType != 3u) {         
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 611 "..\\..\\uCOS-II\\Source\\os_sem.c"

#line 618 "..\\..\\uCOS-II\\Source\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return;
    }
