...
#line 13 "..\\BSP\\bsp_can.c"
#line 14 "..\\BSP\\bsp_can.c"
...
GPIO_TypeDef* CAN_TX_PORT[2] = {		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),
										((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))};
 
GPIO_TypeDef* CAN_RX_PORT[2] = {		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),
										((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))};

const uint32_t CAN_CLK[2] = {			((uint32_t)0x02000000),
										(((uint32_t)0x02000000) | ((uint32_t)0x04000000))};

const uint32_t CAN_TX_PORT_CLK[2] = {	((uint32_t)0x00000001),
										((uint32_t)0x00000002)
									};
 
const uint32_t CAN_RX_PORT_CLK[2] = {	((uint32_t)0x00000001),
										((uint32_t)0x00000002)
									};

const uint16_t CAN_TX_PIN[2] = 		{	((uint16_t)0x1000),
										((uint16_t)0x2000)
									};

const uint16_t CAN_RX_PIN[2] = 		{	((uint16_t)0x0800),
										((uint16_t)0x1000)
									};
 
const uint8_t CAN_TX_SOURCE[2] = {		((uint8_t)0x0C),
										((uint8_t)0x0D)
									};

const uint8_t CAN_RX_SOURCE[2] = {		((uint8_t)0x0B),
										((uint8_t)0x0C)
									};
 
const uint8_t CAN_AF_PORT[2] = {		((uint8_t)0x09),
										((uint8_t)0x09)
									};
 

const uint32_t CanIntID[2] = {	19,
								63};
...
void BSP_InitCan(CAN_TypeDef* CANx, CAN_InitTypeDef *CanInit, CAN_FilterInitTypeDef *FilterInit)
{
	...
	if (CANx == ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)))
		i = 1;
	else if (CANx == ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)))
		i = 2;
	else
		return;
	...
	CAN_ITConfig(CANx, ((uint32_t)0x00000001) | ((uint32_t)0x00000002), ENABLE);
...
void Can1_Isr(void)
{
	...
	if (CAN_MessagePending(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00))){
		
		i = BSP_Info.CanRxMsgIndex[0];
		MsgPtr = BSP_Info.CanRxMsgPtr[0] + i;
		CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00), MsgPtr);
...
void Can2_Isr(void)
{
	...
	if (CAN_MessagePending(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint8_t)0x00))){
		
		i = BSP_Info.CanRxMsgIndex[1];
		MsgPtr = BSP_Info.CanRxMsgPtr[1] + i;
		CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint8_t)0x00), MsgPtr);
