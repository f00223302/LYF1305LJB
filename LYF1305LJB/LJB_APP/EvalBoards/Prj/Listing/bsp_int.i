...
static  CPU_FNCT_VOID  BSP_IntVectTbl[81];
...
void  BSP_IntHandlerWWDG               (void)  { BSP_IntHandler(0);                }
void  BSP_IntHandlerPVD                (void)  { BSP_IntHandler(1);                 }
void  BSP_IntHandlerTAMPER             (void)  { BSP_IntHandler(2);              }
void  BSP_IntHandlerRTC                (void)  { BSP_IntHandler(3);                 }
void  BSP_IntHandlerFLASH              (void)  { BSP_IntHandler(4);               }
void  BSP_IntHandlerRCC                (void)  { BSP_IntHandler(5);                 }
void  BSP_IntHandlerEXTI0              (void)  { BSP_IntHandler(6);               }
void  BSP_IntHandlerEXTI1              (void)  { BSP_IntHandler(7);               }
void  BSP_IntHandlerEXTI2              (void)  { BSP_IntHandler(8);               }
void  BSP_IntHandlerEXTI3              (void)  { BSP_IntHandler(9);               }
void  BSP_IntHandlerEXTI4              (void)  { BSP_IntHandler(10);               }
...
void  BSP_IntHandlerDMA1_STREAM0       (void)  { BSP_IntHandler(11);        }
void  BSP_IntHandlerDMA1_STREAM1       (void)  { BSP_IntHandler(12);        }
void  BSP_IntHandlerDMA1_STREAM2       (void)  { BSP_IntHandler(13);        }
void  BSP_IntHandlerDMA1_STREAM3       (void)  { BSP_IntHandler(14);        }
void  BSP_IntHandlerDMA1_STREAM4       (void)  { BSP_IntHandler(15);        }
void  BSP_IntHandlerDMA1_STREAM5       (void)  { BSP_IntHandler(16);        }
void  BSP_IntHandlerDMA1_STREAM6       (void)  { BSP_IntHandler(17);        }

void  BSP_IntHandlerADC1_2             (void)  { BSP_IntHandler(18);              }
void  BSP_IntHandlerCAN1_TX            (void)  { BSP_IntHandler(19);             }
void  BSP_IntHandlerCAN1_RX0           (void)  { BSP_IntHandler(20);            }
void  BSP_IntHandlerCAN1_RX1           (void)  { BSP_IntHandler(21);            }
void  BSP_IntHandlerCAN1_SCE           (void)  { BSP_IntHandler(22);            }
void  BSP_IntHandlerEXTI9_5            (void)  { BSP_IntHandler(23);             }
void  BSP_IntHandlerTIM1_BRK           (void)  { BSP_IntHandler(24);            }
void  BSP_IntHandlerTIM1_UP            (void)  { BSP_IntHandler(25);             }
void  BSP_IntHandlerTIM1_TRG_COM       (void)  { BSP_IntHandler(26);        }
void  BSP_IntHandlerTIM1_CC            (void)  { BSP_IntHandler(27);             }
void  BSP_IntHandlerTIM2               (void)  { BSP_IntHandler(28);                }
void  BSP_IntHandlerTIM3               (void)  { BSP_IntHandler(29);                }
void  BSP_IntHandlerTIM4               (void)  { BSP_IntHandler(30);                }
void  BSP_IntHandlerI2C1_EV            (void)  { BSP_IntHandler(31);             }
void  BSP_IntHandlerI2C1_ER            (void)  { BSP_IntHandler(32);             }
void  BSP_IntHandlerI2C2_EV            (void)  { BSP_IntHandler(33);             }
void  BSP_IntHandlerI2C2_ER            (void)  { BSP_IntHandler(34);             }
void  BSP_IntHandlerSPI1               (void)  { BSP_IntHandler(35);                }
void  BSP_IntHandlerSPI2               (void)  { BSP_IntHandler(36);                }
void  BSP_IntHandlerUSART1             (void)  { BSP_IntHandler(37);              }
void  BSP_IntHandlerUSART2             (void)  { BSP_IntHandler(38);              }
void  BSP_IntHandlerUSART3             (void)  { BSP_IntHandler(39);              }
void  BSP_IntHandlerEXTI15_10          (void)  { BSP_IntHandler(40);           }
void  BSP_IntHandlerRTCAlarm           (void)  { BSP_IntHandler(41);           }
void  BSP_IntHandlerUSBWakeUp          (void)  { BSP_IntHandler(42);         }
void  BSP_IntHandlerTIM8_BRK_TIM12     (void)  { BSP_IntHandler(43);      }
void  BSP_IntHandlerTIM8_UP_TIM13      (void)  { BSP_IntHandler(44);       }
void  BSP_IntHandlerTIM8_TRG_COM_TIM14 (void)  { BSP_IntHandler(45);  }
void  BSP_IntHandlerTIM8_CC            (void)  { BSP_IntHandler(46);             }
void  BSP_IntHandlerDMA1_STREAM7       (void)  { BSP_IntHandler(47);        }
void  BSP_IntHandlerFSMC               (void)  { BSP_IntHandler(48);                }
void  BSP_IntHandlerSDIO               (void)  { BSP_IntHandler(49);                }
void  BSP_IntHandlerTIM5               (void)  { BSP_IntHandler(50);                }
void  BSP_IntHandlerSPI3               (void)  { BSP_IntHandler(51);                }
void  BSP_IntHandlerUSART4             (void)  { BSP_IntHandler(52);              }
void  BSP_IntHandlerUSART5             (void)  { BSP_IntHandler(53);              }
void  BSP_IntHandlerTIM6               (void)  { BSP_IntHandler(54);                }
void  BSP_IntHandlerTIM7               (void)  { BSP_IntHandler(55);                }
...
void  BSP_IntHandlerDMA2_STREAM0       (void)  { BSP_IntHandler(56);        }
void  BSP_IntHandlerDMA2_STREAM1       (void)  { BSP_IntHandler(57);        }
void  BSP_IntHandlerDMA2_STREAM2       (void)  { BSP_IntHandler(58);        }
void  BSP_IntHandlerDMA2_STREAM3       (void)  { BSP_IntHandler(59);        }
void  BSP_IntHandlerDMA2_STREAM4       (void)  { BSP_IntHandler(60);        }


void  BSP_IntHandlerETH                (void)  { BSP_IntHandler(61);                 }
void  BSP_IntHandlerETHWakeup          (void)  { BSP_IntHandler(62);            }
void  BSP_IntHandlerCAN2_TX            (void)  { BSP_IntHandler(63);             }
void  BSP_IntHandlerCAN2_RX0           (void)  { BSP_IntHandler(64);            }
void  BSP_IntHandlerCAN2_RX1           (void)  { BSP_IntHandler(65);            }
void  BSP_IntHandlerCAN2_SCE           (void)  { BSP_IntHandler(66);            }
void  BSP_IntHandlerOTG                (void)  { BSP_IntHandler(67);              }
...
void  BSP_IntHandlerDMA2_STREAM5       (void)  { BSP_IntHandler(68);        }
void  BSP_IntHandlerDMA2_STREAM6       (void)  { BSP_IntHandler(69);        }
void  BSP_IntHandlerDMA2_STREAM7       (void)  { BSP_IntHandler(70);        }


void  BSP_IntHandlerUSART6             (void)  { BSP_IntHandler(71);              }
void  BSP_IntHandlerI2C3_EV            (void)  { BSP_IntHandler(72);             }
void  BSP_IntHandlerI2C3_ER            (void)  { BSP_IntHandler(73);             }
void  BSP_IntHandlerOTG_HS_EP1_OUT     (void)  { BSP_IntHandler(74);      }
void  BSP_IntHandlerOTG_HS_EP1_IN      (void)  { BSP_IntHandler(75);       }
void  BSP_IntHandlerOTG_HS_WKUP        (void)  { BSP_IntHandler(76);         }
void  BSP_IntHandlerOTG_HS             (void)  { BSP_IntHandler(77);              }
void  BSP_IntHandlerDCMI               (void)  { BSP_IntHandler(78);                }
void  BSP_IntHandlerCRYP               (void)  { BSP_IntHandler(79);                }
void  BSP_IntHandlerHASH_RNG           (void)  { BSP_IntHandler(80);            }
