...
#line 19 "..\\App\\app_usart6.c"
#line 20 "..\\App\\app_usart6.c"
...
uint8_t		Usart6RxBuf[((uint16_t)1 << 10)];
uint8_t		Usart6TxBuf[((uint16_t)1 << 8)];




uint8_t		_tmpRxBuf6[((uint16_t)1 << 10)];
uint8_t		_tmpTxBuf6[((uint16_t)1 << 8)];
DATA_STRUCT _RxInfo6;
DATA_STRUCT _TxInfo6;


U6_TXFRMBUF U6_TxFrmBuf; 

#line 151 "..\\App\\app_usart6.c"
...
#line 313 "..\\App\\app_usart6.c"
		...
		case 0x27:         
			...
			_TxInfo6.data[1] = 0x01;
			_TxInfo6.data[2] = 0x00;
 			_TxInfo6.data[3] = 0x20;
			_TxInfo6.data[4] = 0x14;
			_TxInfo6.data[5] = 0x07;
			_TxInfo6.data[6] = 0x18;

			
			_TxInfo6.data[7] = (1<<0);

			_TxInfo6.data[8] = 0x10;
			_TxInfo6.data[9] = 0x00;
 			_TxInfo6.data[10] = 0x20;
			_TxInfo6.data[11] = 0x14;
			_TxInfo6.data[12] = 0x07;
			_TxInfo6.data[13] = 0x18;
		...
		case 0x18:   
		    ...
		    if(RecInfo.TotNewRec)  			
		    {
				_TxInfo6.len[1] = 8 + 16;

			    if(RecInfo.NextIndex == 1)
			    {
			        XferRecIndex = ((512 >> 4) - 1);
			    }
			    else
			    {
...
#line 538 "..\\App\\app_usart6.c"


#line 572 "..\\App\\app_usart6.c"


#line 613 "..\\App\\app_usart6.c"
...
#line 897 "..\\App\\app_usart6.c"
			...
			AppInfo.AdcRatio[i] = (float)temp / 256;
		}
			...
			if ((len & 0x03) == 0)
			{
				...
				if (Info->data[0] + len < 6)
				{
					...
					{	
						...
						AppInfo.AdcRatio[i + Info->data[0]] = (float)temp / 256;
					}
					err = 0;
				}
			}
