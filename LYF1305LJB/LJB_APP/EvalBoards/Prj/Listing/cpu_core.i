...
CPU_DATA  CPU_CntLeadZeros08 (CPU_INT08U  val)
{
    ...
    nbr_lead_zeros -= (4 - 1) * 8u;


#line 1231 "..\\..\\uC-CPU\\cpu_core.c"
...
CPU_DATA  CPU_CntLeadZeros16 (CPU_INT16U  val)
{
    ...
    nbr_lead_zeros  =  CPU_CntLeadZeros((CPU_DATA)val);
    nbr_lead_zeros -= (4 - 2) * 8u;


#line 1305 "..\\..\\uC-CPU\\cpu_core.c"
...
CPU_DATA  CPU_CntLeadZeros32 (CPU_INT32U  val)
{
    ...
    nbr_lead_zeros  =  CPU_CntLeadZeros((CPU_DATA)val);
    nbr_lead_zeros -= (4 - 4) * 8u;


#line 1393 "..\\..\\uC-CPU\\cpu_core.c"
    ...
    if (val > 0x00000000FFFFFFFFu) {
        ...
        if (val > 0x000000000000FFFFu) {
            if (val > 0x0000000000FFFFFFu) {                                     
                ...
                ix             = (CPU_DATA)(val >> 24u);                         
                nbr_lead_zeros = (CPU_DATA)(CPU_CntLeadZerosTbl[ix] + 32u);      

            } else {                                                             
                                                                                 
                ix             = (CPU_DATA)(val >> 16u);                         
                nbr_lead_zeros = (CPU_DATA)(CPU_CntLeadZerosTbl[ix] + 40u);      
            }
            ...
            if (val > 0x00000000000000FFu) {                                     
                ...
                ix             = (CPU_DATA)(val >>  8u);                         
                nbr_lead_zeros = (CPU_DATA)(CPU_CntLeadZerosTbl[ix] + 48u);      

            } else {                                                             
                                                                                 
                ix             = (CPU_DATA)(val >>  0u);                         
                nbr_lead_zeros = (CPU_DATA)(CPU_CntLeadZerosTbl[ix] + 56u);      
            }
        }
    }
...
CPU_DATA  CPU_CntTrailZeros64 (CPU_INT64U  val)
{
    ...
    nbr_trail_zeros = ((8 * 8u) - 1u) - nbr_lead_zeros;
