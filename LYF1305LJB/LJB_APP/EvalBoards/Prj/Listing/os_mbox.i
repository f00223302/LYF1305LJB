...
#line 28 "..\\..\\uCOS-II\\Source\\os_mbox.c"
...
#line 105 "..\\..\\uCOS-II\\Source\\os_mbox.c"
...
#line 184 "..\\..\\uCOS-II\\Source\\os_mbox.c"

#line 191 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (pevent);
    }
...
#line 305 "..\\..\\uCOS-II\\Source\\os_mbox.c"

#line 312 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        *perr = 1u;
        return ((void *)0);
    }
...
#line 418 "..\\..\\uCOS-II\\Source\\os_mbox.c"

#line 425 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (0u);
    }
...
#line 498 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 571 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 639 "..\\..\\uCOS-II\\Source\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
