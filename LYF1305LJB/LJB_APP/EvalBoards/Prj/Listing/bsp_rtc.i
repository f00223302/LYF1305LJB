...
#line 16 "..\\BSP\\bsp_rtc.c"
#line 17 "..\\BSP\\bsp_rtc.c"
#line 1 "..\\BSP\\bsp.h"
...
void BSP_InitRTC(void)
{
	...
	if (RTC_ReadBackupRegister(((uint32_t)0x00000000)) != 0x32F2){ 
		...
		RTC_ClearFlag(((uint32_t)0x00000100));
	...
	BSP_IntVectSet(3, BSP_RTC_IsrHandler);
    BSP_IntEn(3);
...
void BSP_SetDateTime(RTC_TimeTypeDef *Time, RTC_DateTypeDef *Date)
{
	...
	Time->RTC_H12     = ((uint8_t)0x00);
  
	 
	RTC_AlarmCmd(((uint32_t)0x00000100), DISABLE);
	
	status = RTC_SetDateTime(((uint32_t)0x000000000), Date, Time);
	if (status == ERROR){
	}
	else{
	}
	...
	RTC_AlarmCmd(((uint32_t)0x00000100), ENABLE);
}
...
void RTC_TimeRegulate(void)
{
	...
	RTC_TimeStructure.RTC_H12 = ((uint8_t)0x00);
  
	RTC_TimeStructure.RTC_Hours = 0x00;
    RTC_TimeStructure.RTC_Minutes = 0x00;
    RTC_TimeStructure.RTC_Seconds = 0x00;
	 
	if(RTC_SetTime(((uint32_t)0x000000001), &RTC_TimeStructure) == ERROR)
	{
		;
	} 
	else
	...
	if(RTC_SetDate(((uint32_t)0x000000001), &RTC_DateStructure) == ERROR)
	{
		;
	} 
	else
	{
		...
		RTC_WriteBackupRegister(((uint32_t)0x00000000), 0x32F2);
	}
	...
	;
	RTC_AlarmStructure.RTC_AlarmTime.RTC_H12 = ((uint8_t)0x00);
	...
	RTC_AlarmStructure.RTC_AlarmDateWeekDaySel = ((uint32_t)0x00000000);
	RTC_AlarmStructure.RTC_AlarmMask = ((uint32_t)0x80808080);

	 
	RTC_SetAlarm(((uint32_t)0x000000001), ((uint32_t)0x00000100), &RTC_AlarmStructure);

	 
	RTC_ITConfig(((uint32_t)0x00001000), ENABLE);
...
void BSP_RTC_IsrHandler(void)
{
	if(RTC_GetITStatus(((uint32_t)0x00001000)) != RESET)
	{
		...
		if (BSP_Info.RTCCalBack)
			BSP_Info.RTCCalBack(0, 0);
		
		RTC_ClearITPendingBit(((uint32_t)0x00001000));
		EXTI_ClearITPendingBit(((uint32_t)0x20000));
	} 
}
