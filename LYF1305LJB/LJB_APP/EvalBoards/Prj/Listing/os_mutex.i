...
#line 28 "..\\..\\uCOS-II\\Source\\os_mutex.c"
...
#line 109 "..\\..\\uCOS-II\\Source\\os_mutex.c"
...
#line 193 "..\\..\\uCOS-II\\Source\\os_mutex.c"

#line 200 "..\\..\\uCOS-II\\Source\\os_mutex.c"

#line 209 "..\\..\\uCOS-II\\Source\\os_mutex.c"
    if (OSIntNesting > 0u) {                                
        *perr = 16u;                          
        return ((OS_EVENT *)0);
    }
...
#line 308 "..\\..\\uCOS-II\\Source\\os_mutex.c"

#line 315 "..\\..\\uCOS-II\\Source\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        *perr = 1u;
        return (pevent);
    }
...
#line 459 "..\\..\\uCOS-II\\Source\\os_mutex.c"

#line 466 "..\\..\\uCOS-II\\Source\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        *perr = 1u;
        return;
    }
...
#line 698 "..\\..\\uCOS-II\\Source\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
