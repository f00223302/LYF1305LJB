...
#line 28 "..\\..\\uCOS-II\\Source\\os_flag.c"
...
#line 121 "..\\..\\uCOS-II\\Source\\os_flag.c"
...
#line 233 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 240 "..\\..\\uCOS-II\\Source\\os_flag.c"
...
#line 324 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 331 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (OSIntNesting > 0u) {                                
        *perr = 15u;                             
        return (pgrp);
    }
...
#line 437 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 448 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (OSIntNesting > 0u) {                      
        *perr = 17u;
        return (0u);
    }
...
#line 507 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 518 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (OSIntNesting > 0u) {                      
        *perr = 18u;
        return;
    }
...
#line 613 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 620 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (OSIntNesting > 0u) {                                
        *perr = 2u;                            
        return ((OS_FLAGS)0);
    }
...
#line 855 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 862 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (pgrp->OSFlagType != 5u) {     
        *perr = 1u;
        return ((OS_FLAGS)0);
    }
...
#line 981 "..\\..\\uCOS-II\\Source\\os_flag.c"

#line 988 "..\\..\\uCOS-II\\Source\\os_flag.c"
    if (pgrp->OSFlagType != 5u) {  
        *perr = 1u;
        return ((OS_FLAGS)0);
    }
...
void  OS_FlagInit (void)
{
#line 1100 "..\\..\\uCOS-II\\Source\\os_flag.c"
