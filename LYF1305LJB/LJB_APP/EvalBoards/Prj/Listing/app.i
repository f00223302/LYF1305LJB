...
typedef struct{
	...
	uint8_t		OneSecAlarmFlag;	
	uint8_t		OrderOf1Sec;		
	uint8_t		TaxTimeValid;		
	uint8_t		UserTimeValid;		
	uint8_t		TaxDataValid38;	
	uint8_t		TaxDataValid39;	
	...
	uint16_t	TaskUsartCnt[6];		
	uint32_t	UsartNoDataCnt[6];		
...
extern volatile  uint8_t PowF;
extern volatile  uint8_t PosIndex;

extern uint8_t CalibrationInfo[5][4];


extern volatile uint8_t  D110VADBuf[5][10];
extern      uint8_t  D110VCnt[10];
extern      uint8_t  g_I2C_RdyF;
extern volatile uint8_t  g_changed;
...
#line 37 "..\\App\\F205_Flash.h"

 
#line 40 "..\\App\\F205_Flash.h"
...
#line 55 "..\\App\\F205_Flash.h"


 
 
 
#line 66 "..\\App\\F205_Flash.h"


#line 74 "..\\App\\F205_Flash.h"
...
#line 19 "..\\App\\app_usart1.h"
#line 20 "..\\App\\app_usart1.h"
...
extern uint8_t		Usart1RxBuf[((uint16_t)1 << 10)];
extern uint8_t		Usart1TxBuf[((uint16_t)1 << 10)];
...
#line 19 "..\\App\\app_usart6.h"
#line 20 "..\\App\\app_usart6.h"
#line 21 "..\\App\\app_usart6.h"
#line 22 "..\\App\\app_usart6.h"
...
extern uint8_t		Usart6RxBuf[((uint16_t)1 << 10)];
extern uint8_t		Usart6TxBuf[((uint16_t)1 << 8)];
...
extern U6_TXFRMBUF U6_TxFrmBuf; 
...
static  OS_STK          AppTaskUsartStk_1[1024u];
...
static  OS_STK          AppTaskUsartStk_6[512u];
...
static  OS_STK          AppTaskADCStk[512u];
...
static  OS_STK          AppTaskI2C1Stk[512u];
...
APP_INFO    AppInfo;
LJBPOS_INFO    LJBPosInfo;
REC_INFO    RecInfo;




volatile uint8_t CompexInCnt;
volatile uint16_t PowOffTm;
volatile uint8_t CompCnt;
volatile uint8_t V110Ready;
volatile uint8_t TimeUsed;
volatile uint8_t PowF;
volatile uint8_t PosIndex = 0;

volatile uint8_t g_changed;

volatile uint8_t XferRecIndex; 

uint8_t CalibrationInfo[5][4];
...
volatile uint16_t Tm10ms = 0;
volatile uint16_t WkTime = 0;

volatile uint8_t  D110VADBuf[5][10]; 
...
int main(void)
{
 ...
 if(size!=16)
    ...
    OSTaskNameSet(55u, (uint8_t *)"Start", &err);
...
static  void  AppTaskStart (void *p_arg)
{
    ...
    ((1u >= 1u) ? (void)(BSP_Ser_Printf ("Creating Application Events...\n\r")) : (void)0);
    AppEventCreate();                                            

    ((1u >= 1u) ? (void)(BSP_Ser_Printf ("Creating Application Tasks...\n\r")) : (void)0);
    AppTaskCreate();                                             
...
#line 672 "..\\App\\app.c"
    ...
    while (1u)
    {
        ...
        if (AppInfo.UsartNoDataCnt[COM1] >= 300000L)
        {
            AppInfo.ResetF = 1;
...
static  void  AppTaskCreate (void)
{
    ...
    OSTaskCreateExt((void (*)(void *)) AppTaskUsart1,            
                    (void           *) 0,
                    (OS_STK         *)&AppTaskUsartStk_1[1024u - 1],
                    (INT8U           ) 21u,
                    (INT16U          ) 21u,
    ...
    OSTaskNameSet(21u, (unsigned char *)"Usart1", &err);
...
#line 899 "..\\App\\app.c"
    ...
    OSTaskCreateExt((void (*)(void *)) AppTaskUsart6,            
                    (void           *) 0,
                    (OS_STK         *)&AppTaskUsartStk_6[512u - 1],
                    (INT8U           ) 26u,
                    (INT16U          ) 26u,
    ...
    OSTaskNameSet(26u, (unsigned char *)"Usart6", &err);
    ...
    OSTaskCreateExt((void (*)(void *)) AppTaskADC,            
                    (void           *) 0,
                    (OS_STK         *)&AppTaskADCStk[512u - 1],
                    (INT8U           ) 11u,
                    (INT16U          ) 11u,
    ...
    OSTaskNameSet(11u, (unsigned char *)"ADC", &err);
...
#line 973 "..\\App\\app.c"
    ...
    OSTaskCreateExt((void (*)(void *)) AppTaskI2C1,            
                    (void           *) 0,
                    (OS_STK         *)&AppTaskI2C1Stk[512u - 1],
                    (INT8U           ) 27u,
                    (INT16U          ) 27u,
    ...
    OSTaskNameSet(27u, (unsigned char *)"I2C_1", &err);
...
void SetBSPInfo(void)
{
    ...
    BSP_Info.UsartRxBufMask[COM1] = (((uint16_t)1 << 10) - 1);
    BSP_Info.UsartTxBufMask[COM1] = (((uint16_t)1 << 10) - 1);
...
#line 1159 "..\\App\\app.c"
    ...
    BSP_Info.UsartRxBufMask[COM6] = (((uint16_t)1 << 10) - 1);
    BSP_Info.UsartTxBufMask[COM6] = (((uint16_t)1 << 8) - 1);
...
void GetParams(void)
{
    ...
    F205_ReadParams((uint32_t)0x08008000, &(ParamBuf[0]), sizeof(ParamBuf));
    crc = Calc_CRCByte(ParamBuf + 16, 14);
    tmp = ((uint16_t)ParamBuf[30] << 8) + ParamBuf[31];
    if ((crc != tmp) || (ParamBuf[16] != 0x71) || (ParamBuf[17] != 0x61) ||         (ParamBuf[18] != 0x42) || (ParamBuf[19] != 0x55)||         (ParamBuf[20] != 0x10) || (ParamBuf[21] != 0x00) ||         (ParamBuf[22] != 0x20) || (ParamBuf[23] != 0x13) ||         (ParamBuf[24] != 0x10) || (ParamBuf[25] != 0x10))
    ...
    if (err)
    {
        ...
        err = F205_EraseSectors(((uint16_t)0x0010), ((uint16_t)0x0010));

        if (!err)
        {

            addr = (uint32_t)0x08008000;
...
void SetChParams(void)
{
    ...
    if (crc != tmp)
    {
        for (i = 0; i < 5; i++)
        {
            ...
            AppInfo.AdcRatio[i] = (float)962 / 256;
        }
    }
    else
    {
	    ...
	    tmp = (((uint16_t)ParamBuf[36 + (i << 2) + 3] << 8) + ParamBuf[36 + (i << 2) + 2]) ;
            ...
            {
	         AppInfo.AdcRatio[i] = (float)(((uint16_t)ParamBuf[36 + (i << 2) + 3] << 8) + ParamBuf[36 + (i << 2) + 2]) / 256;
            }
        }
    }
...
void CheckRecInfo(void)
{
    ...
    if ((RecInfo.Flag[0] == 0x61) && (RecInfo.Flag[1] == 0x62) &&         (RecInfo.Flag[2] == 0x52) && (RecInfo.Flag[3] == 0x51))

    {
        if ((RecInfo.NextIndex < ((512 >> 4) - 1) + 1) && (RecInfo.NextIndex > 0))
        {
    ...
    if ((RecInfo.Bk_Flag[0] == 0x61) && (RecInfo.Bk_Flag[1] == 0x62) &&         (RecInfo.Bk_Flag[2] == 0x52) && (RecInfo.Bk_Flag[3] == 0x51))

    {
        if ((RecInfo.Bk_NextIndex < ((512 >> 4) - 1) + 1) && (RecInfo.Bk_NextIndex > 0))
        {
...
void SavePowOffData()
{
    ...
    if (RecInfo.TotNewRec > ((512 >> 4) - 1))
    {
        RecInfo.TotNewRec = ((512 >> 4) - 1);
    }
...
#line 1866 "..\\App\\app.c"
        ...
        if ((g_I2C_RdyF == 1)&&(g_changed == 1))                            
        {
            SavePowOffData();                       
        }

        g_changed = 0;                                
        UserInf.PowOffFlag &= (~1);       
    }
}
