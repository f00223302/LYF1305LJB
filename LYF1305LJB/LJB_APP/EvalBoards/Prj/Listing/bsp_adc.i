...
#line 21 "..\\BSP\\bsp_ADC.c"
#line 22 "..\\BSP\\bsp_ADC.c"
#line 23 "..\\BSP\\bsp_ADC.c"
#line 1 "..\\BSP\\bsp.h"
...
const GPIO_TypeDef *ADC_GPIO_PORT[] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))};
const uint16_t ADC_GPIO_Pins[] = {((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010)}; 
const uint8_t ADC1_Channels[] = {((uint8_t)0x0A), ((uint8_t)0x0B), ((uint8_t)0x0C), ((uint8_t)0x0D), ((uint8_t)0x0E)};
...
void BSP_ADC_Init(uint16_t *ResBuf)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00400000) | (((uint32_t)0x00000004)), ENABLE); 
...
#line 165 "..\\BSP\\bsp_ADC.c"


	
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x00000010), ENABLE);
	DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x10000020));
	
	BSP_IntVectSet(56, BSP_ADC1_DMA_ISRHandler);
    BSP_IntEn(56);
  	...
  	DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), DISABLE); 
}
...
void BSP_ADC_Start(void)
{
	...
	if (!(BSP_Info.Error & 0x00000001))
	{
		...
		if (DMA_GetCmdStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010))) == DISABLE)
		{

#line 208 "..\\BSP\\bsp_ADC.c"
			
			
			DMA_SetCurrDataCounter(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), 5);
...
void ADC1_Config(void)
{
	...
	for (i = 0; i < 5; i++)
	{
		ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ADC1_Channels[i], i + 1, ((uint8_t)0x06));
	}   	
}
...
void ADC_DMAConfig(uint16_t *ResBuf)
{
  	...
  	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)(((((uint32_t)0x40000000) + 0x00010000) + 0x2000) + 0x4C);
...
void ADC_GPIOConfig(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010);
...
void BSP_ADC1_DMA_ISRHandler(void)
{
	...
	status = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x6400))->LISR;

	
	if (((((0x20u) != 0u) && (((status) & (0x20u)) == (0x20u))) ? (1u) : (0u )))
	{

		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x10008020));
	...
	if (((((0x08u) != 0u) && (((status) & (0x08u)) == (0x08u))) ? (1u) : (0u )))
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x10002008));	

	
	if (((((0x01u) != 0u) && (((status) & (0x01u)) == (0x01u))) ? (1u) : (0u )))
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x90000001));	
}




#line 365 "..\\BSP\\bsp_ADC.c"
