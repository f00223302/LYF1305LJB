...
#line 85 "..\\App\\app_adc.c"


uint16_t    AdcBuf[5];

uint16_t _ResBuf[((uint32_t)1 << 4)][5];

volatile uint16_t _ResIndex = 0;

volatile uint16_t _ResHandleIndex = 0;

volatile uint32_t _TotBuf[5] = {0, 0, 0, 0, 0};

volatile uint16_t _TotCnt = 0;
...
void BSP_Check_RestADC1(uint16_t *ResBuf)
{
    if(ADC_GetFlagStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x20)))
    {
        ADC_ClearFlag(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x20));
...
void GetSampleOffset(uint16_t *buf)
{
    ...
    {
        tot[i] = 0;
        for (j = 0; j < ((uint32_t)1 << 4); j++)
        {
            tot[i] += _ResBuf[j][i];
        }

        buf[i] = tot[i] / ((uint32_t)1 << 4);
    }
...
void GetSampleValues(uint16_t *buf)
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        tmp = AppInfo.AdcRatio[i] * tot[i] / ((uint32_t)1 << 4);
...
void SaveAdcData(void)
{
    ...
    if (_TotCnt >= ((uint16_t)1 << 4))
    {
        ...
        _ResIndex++;
        _ResIndex &= (((uint32_t)1 << 4) - 1);
    }

#line 302 "..\\App\\app_adc.c"


#line 328 "..\\App\\app_adc.c"
...
#line 360 "..\\App\\app_adc.c"
    ...
    if (val[4] < 6000)                   
    {
        ...
        if (g_UsartRWPowOffComplete == 1)                 
        {


            {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRL = ((uint16_t)0x0800); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRL = ((uint16_t)0x0200);};                        
    ...
    else
    {
        ...
        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRH = ((uint16_t)0x0800); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRH = ((uint16_t)0x0200);};                           
    }
}
...
#line 514 "..\\App\\app_adc.c"




#line 611 "..\\App\\app_adc.c"
...
#line 1131 "..\\App\\app_adc.c"





#line 1397 "..\\App\\app_adc.c"


#line 1438 "..\\App\\app_adc.c"
