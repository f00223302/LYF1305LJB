...
void BSP_GPIO_Init(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000001), ENABLE);
  	...
  	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0004) | ((uint16_t)0x0800) | ((uint16_t)0x1000);
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400);
  	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
  	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
  	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
...
void BSP_FeedDog(void)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->ODR ^= ((uint16_t)0x0100);

}

uint8_t		BSP_DetectSD(void)
{
	return (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x8000)));
}
...
void 	BSP_EnableUsartTx(COM_TypeDef com, uint8_t enable)
{
	switch (com)
	{
		case COM1:
			if (enable)
			{
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRH = ((uint16_t)0x1000);
			}
			else
			{
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRRL = ((uint16_t)0x1000);
			}
			break;
		...
		case COM6:
			if (enable)
			{	
			    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRH = ((uint16_t)0x0400);
			}
			else
			{
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRL = ((uint16_t)0x0400);
			}
			break;
...
void EXTILine6_Config(void)
{
	...
	SYSCFG_EXTILineConfig(((uint8_t)0x05), ((uint8_t)0x06));

	 
	EXTI_InitStructure.EXTI_Line = ((uint32_t)0x00040);
...
void EXTILine7_Config(void)
{
	...
	SYSCFG_EXTILineConfig(((uint8_t)0x05), ((uint8_t)0x07));
...
void BSP_EXTI9_5_ISRHandler(void)
{
	...
	{    
		...
		EXTI_ClearITPendingBit(((uint32_t)0x00080));
		status |= 2;
	}
	
	if (BSP_Info.EXTI9_5_CallBack)
		BSP_Info.EXTI9_5_CallBack(status, 0);
}
