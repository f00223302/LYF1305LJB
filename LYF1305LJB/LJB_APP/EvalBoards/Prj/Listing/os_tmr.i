...
#line 29 "..\\..\\uCOS-II\\Source\\os_tmr.c"
...
#line 129 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 136 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 158 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (OSIntNesting > 0u) {                                 
        *perr  = 139u;
        return ((OS_TMR *)0);
    }
...
BOOLEAN  OSTmrDel (OS_TMR  *ptmr,
                   INT8U   *perr)
{
#line 220 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 227 "..\\..\\uCOS-II\\Source\\os_tmr.c"
...
#line 302 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 313 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (ptmr->OSTmrType != 100u) {               
        *perr = 137u;
        return (0u);
    }
...
#line 381 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 388 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (ptmr->OSTmrType != 100u) {               
        *perr = 137u;
        return (0u);
    }
...
#line 482 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 489 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (ptmr->OSTmrType != 100u) {               
        *perr = 137u;
        return (0u);
    }
...
BOOLEAN  OSTmrStart (OS_TMR   *ptmr,
                     INT8U    *perr)
{
#line 548 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 555 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (ptmr->OSTmrType != 100u) {                    
        *perr = 137u;
        return (0u);
    }
...
#line 645 "..\\..\\uCOS-II\\Source\\os_tmr.c"

#line 652 "..\\..\\uCOS-II\\Source\\os_tmr.c"
    if (ptmr->OSTmrType != 100u) {                          
        *perr = 137u;
        return (0u);
    }
...
static  void  OSTmr_InitTask (void)
{
    ...
    (void)OSTaskCreateExt(OSTmr_Task,
                          ...
                          (void *)0,                                        
                          0x0001u | 0x0002u);       
#line 929 "..\\..\\uCOS-II\\Source\\os_tmr.c"


    OSTaskNameSet((63u - 2), (INT8U *)(void *)"uC/OS-II Tmr", &err);
