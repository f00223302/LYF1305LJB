...
#line 41 "..\\BSP\\bsp_ser.c"
#line 42 "..\\BSP\\bsp_ser.c"
...
void  BSP_Ser_Init (CPU_INT32U  baud_rate)
{
    ...
    USART_CLK_InitStructure.USART_Clock           = ((uint16_t)0x0000);
    USART_CLK_InitStructure.USART_CPOL            = ((uint16_t)0x0000);
    USART_CLK_InitStructure.USART_CPHA            = ((uint16_t)0x0200);
    USART_CLK_InitStructure.USART_LastBit         = ((uint16_t)0x0000);
    ...
    USART_ClockInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), &USART_CLK_InitStructure);
    USART_Cmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ENABLE);

    BSP_IntVectSet(39, BSP_Ser_ISR_Handler);
    BSP_IntEn(39);
}
...
void  BSP_Ser_ISR_Handler (void)
{
    ...
    if (((((0x20u) != 0u) && (((status) & (0x20u)) == (0x20u))) ? (1u) : (0u ))) {
        BSP_SerRxData = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))) & 0xFF;        
        USART_ClearITPendingBit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0525));          
        BSP_OS_SemPost(&BSP_SerRxWait);                          
    }

    if (((((0x80u) != 0u) && (((status) & (0x80u)) == (0x80u))) ? (1u) : (0u ))) {
        USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0727), DISABLE);
        USART_ClearITPendingBit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0727));           
...
void  BSP_Ser_Printf (CPU_CHAR *format, ...)
{
    CPU_CHAR  buf_str[80u + 1u];
    va_list   v_args;


    __va_start(v_args, format);
...
CPU_INT08U  BSP_Ser_RdByteUnlocked (void)
{
    ...
    USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0525), DISABLE);              
                     ...
                     CPU_INT16U   len)
{
    ...
    err = BSP_OS_SemWait(&BSP_SerLock, 0);                       
    ...
    while (1u)
    {
        ...
        if ((rx_data == 0x0D) ||           
            ...
            BSP_Ser_WrByteUnlocked((CPU_INT08U)0x0A);
            BSP_Ser_WrByteUnlocked((CPU_INT08U)0x0D);
        ...
        if (rx_data == 0x08) {                  
            if (rx_buf_ix > 0) {
                BSP_Ser_WrByteUnlocked((CPU_INT08U)0x08);
                BSP_Ser_WrByteUnlocked((CPU_INT08U)0x20);
                BSP_Ser_WrByteUnlocked((CPU_INT08U)0x08);
        ...
        if (ASCII_IsPrint(rx_data)) {                            
            BSP_Ser_WrByteUnlocked((CPU_INT08U)rx_data);         
            p_str[rx_buf_ix] = rx_data;                          
            rx_buf_ix++;                                         
            if (rx_buf_ix >= len) {
               rx_buf_ix = len;
            }
...
void  BSP_Ser_WrByteUnlocked (CPU_INT08U c)
{
    ...
    USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), c);

    USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0727), ENABLE);
...
void  BSP_Ser_WrStr (CPU_CHAR  *p_str)
{
    ...
    while ((*p_str) != (CPU_CHAR )0) {
        ...
        if (*p_str == 0x0A) {
            BSP_Ser_WrByteUnlocked(0x0D);
            BSP_Ser_WrByteUnlocked(0x0A);
            p_str++;
        } else {
