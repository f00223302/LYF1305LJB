...
SD_Error SD_Init(void)
{
  ...
  SDIO_InitStructure.SDIO_ClockDiv = ((uint8_t)0x0); 
  ...
  if (errorstatus == SD_OK)
  {
    errorstatus = SD_EnableWideBusOperation(((uint32_t)0x00000800));
  }  
...
uint8_t SD_Detect(void)
{
  ...
  if (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x8000)) != Bit_RESET)
  {
    status = ((uint8_t)0x00);
  }
  return status;
...
SD_Error SD_PowerON(void)
{
  ...
  SDIO_InitStructure.SDIO_ClockDiv = ((uint8_t)0x76);
  SDIO_InitStructure.SDIO_ClockEdge = ((uint32_t)0x00000000);
  SDIO_InitStructure.SDIO_ClockBypass = ((uint32_t)0x00000000);
  SDIO_InitStructure.SDIO_ClockPowerSave = ((uint32_t)0x00000000);
  SDIO_InitStructure.SDIO_BusWide = ((uint32_t)0x00000000);
  ...
  else if ((((uint32_t)0x00000000) == CardType) || (((uint32_t)0x00000001) == CardType) || (((uint32_t)0x00000002) == CardType))
  {
    ...
    else if (((uint32_t)0x00000800) == WideMode)
    {
      ...
      if (SD_OK == errorstatus)
      {
		...
		if (SDCardInfo.SD_csd.MaxBusClkFrec == 0x5A)
			SDIO_InitStructure.SDIO_ClockBypass = ((uint32_t)0x00000400);
		else
...
SD_Error SD_ReadBlock(uint8_t *readbuff, uint32_t ReadAddr, uint16_t BlockSize)
{
  ...
  SDIO_DataInitStructure.SDIO_DataTimeOut = ((uint32_t)0xFFFFFFFF);
...
#line 1274 "..\\BSP\\bsp_sd.c"
		BSP_EnableXferDMA((uint32_t *)readbuff, BlockSize, 0);
#line 1281 "..\\BSP\\bsp_sd.c"
...
SD_Error SD_ReadMultiBlocks(uint8_t *readbuff, uint32_t ReadAddr, uint16_t BlockSize, uint32_t NumberOfBlocks)
{
  ...
  if (errorstatus != SD_OK)
  {
    return(errorstatus);
		...
		BSP_EnableXferDMA((uint32_t *)readbuff, (NumberOfBlocks * BlockSize), 0);
...
#line 1506 "..\\BSP\\bsp_sd.c"
		BSP_EnableXferDMA((uint32_t *)writebuff, BlockSize, 1);
#line 1513 "..\\BSP\\bsp_sd.c"
...
SD_Error SD_WriteMultiBlocks(uint8_t *writebuff, uint32_t WriteAddr, uint16_t BlockSize, uint32_t NumberOfBlocks)
{
  ...
  SDIO_DataConfig(&SDIO_DataInitStructure);
		...
		BSP_EnableXferDMA((uint32_t *)writebuff, (NumberOfBlocks * BlockSize), 1);
...
SDTransferState SD_GetTransferState(void)
{
  if (((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->STA & (((uint32_t)0x00001000) | ((uint32_t)0x00002000)))
  {
    return(SD_TRANSFER_BUSY);
  }
  else
...
SD_Error SD_StopTransfer(void)
{
  ...
  ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->ARG = 0x0;
  ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->CMD = 0x44C;
...
SD_Error SD_Erase(uint32_t startaddr, uint32_t endaddr)
{
  ...
  maxdelay = 120000 / ((((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->CLKCR & 0xFF) + 2);
...
SD_Error SD_SendStatus(uint32_t *pcardstatus)
{
  ...
  ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->ARG = (uint32_t) RCA << 16;
  ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->CMD = 0x44D;
...
SD_Error SD_ProcessIRQSrc(void)
{
  if (StopCondition == 1)
  {
    ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->ARG = 0x0;
    ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->CMD = 0x44C;
    TransferError = CmdResp1Error(((uint8_t)12));
  }
  else
  {
    TransferError = SD_OK;
  ...
  SDIO_ITConfig(((uint32_t)0x00000100), DISABLE);
  TransferEnd = 1;
  return(TransferError);
}
...
static SD_Error CmdResp7Error(void)
{
  ...
  SD_Error CmdResp1Error(uint8_t cmd)
{
  while (!(((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->STA & (((uint32_t)0x00000001) | ((uint32_t)0x00000040) | ((uint32_t)0x00000004))))
  {
  }

  ((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->ICR = ((uint32_t)0x000005FF);

  return (SD_Error)(((SDIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2C00))->RESP1 &  ((uint32_t)0xFDFFE008));
}
