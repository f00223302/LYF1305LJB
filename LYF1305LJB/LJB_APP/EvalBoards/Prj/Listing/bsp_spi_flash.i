...
#line 33 "..\\BSP\\bsp_spi_flash.h"

 
 

   
#line 46 "..\\BSP\\bsp_spi_flash.h"
...
void sFLASH_WriteBuffer(uint8_t* pBuffer, uint32_t WriteAddr, uint16_t NumByteToWrite)
{
  ...
  if (Addr == 0)  
  {
    ...
    else  
    {
      while (NumOfPage--)
      {
        sFLASH_WritePage(pBuffer, WriteAddr, 0x100);
        WriteAddr +=  0x100;
        pBuffer += 0x100;
      }
...
void sFLASH_WriteRec(uint8_t *pBuffer, uint32_t WriteAddr, uint16_t NumByteToWrite)
{
...
uint32_t sFLASH_ReadID(void)
{
  ...
  Temp0 = sFLASH_SendByte(0xA5);

   
  Temp1 = sFLASH_SendByte(0xA5);

   
  Temp2 = sFLASH_SendByte(0xA5);
...
void sFLASH_WaitForWriteEnd(void)
{
  ...
  do
  {
    ...
    flashstatus = sFLASH_SendByte(0xA5);
...
void sFLASH_LowLevel_Init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x00000002) | 
                         ((uint32_t)0x00000002) | ((uint32_t)0x00000002), ENABLE);
...
void sFLASH_LowLevel_DeInit(void)
{
  ...
  SPI_Cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), DISABLE);
  
   
  SPI_I2S_DeInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));
  
   
  RCC_APB1PeriphClockCmd(((uint32_t)0x00004000), DISABLE);
