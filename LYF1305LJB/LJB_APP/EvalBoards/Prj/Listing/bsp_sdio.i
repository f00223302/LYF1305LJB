...
#line 12 "..\\BSP\\bsp_sdio.c"
#line 13 "..\\BSP\\bsp_sdio.c"
#line 14 "..\\BSP\\bsp_sdio.c"
...
void BSP_InitSD(void)
{
	...
	SDIO_ITConfig(((uint32_t)0x00000100), ENABLE);
	BSP_IntVectSet(49, BSP_SDIO_ISRHandler);
    BSP_IntEn(49);
}
...
void SD_LowLevel_DMA_TxConfig(uint32_t *BufferSRC, uint32_t BufferSize)
{
	DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x058)), ((uint32_t)0x10400000) | ((uint32_t)0x11000000) | ((uint32_t)0x12000000) | 
					((uint32_t)0x14000000) | ((uint32_t)0x18000000));
