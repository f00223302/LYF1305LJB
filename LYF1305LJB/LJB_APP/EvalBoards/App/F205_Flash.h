...
///Added 20140315
#define ADChPARAM_FLASH_SECTORS	(OB_WRP_Sector_3)


#if USE_CPU_F205RC///CPU：STM32F205RC
...
///Added 20140315
///PARAMS
#define ADChPARAMS_ADDRESS				(uint32_t)0x0800C000
#define ADChPARAMS_START_SECTOR			FLASH_Sector_3
#define ADChPARAMS_END_SECTOR			FLASH_Sector_3
...
typedef struct {
	...
	uint8_t CalibrationInfo[CHANNEL_COUNT_LIMIT][4];
	uint8_t MaintenanceInfo[MAINT_COUNT_LIMIT][16];
	uint8_t MaintOffset;
	uint8_t rsvd;
	uint16_t crc;
}FLASH_INFO_STRUCT, *pFLASH_INFO_STRUCT;

extern FLASH_INFO_STRUCT FlashInfo;
#endif
