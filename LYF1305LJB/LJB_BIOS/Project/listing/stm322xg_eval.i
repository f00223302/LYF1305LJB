#line 1 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
...
#line 41 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 42 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
...
#line 43 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 44 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 45 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 46 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 47 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 48 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 49 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 50 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
#line 51 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"

#line 53 "..\\..\\Utilities\\STM32_EVAL\\stm322xg_eval.c"
...
GPIO_TypeDef* GPIO_PORT[12] = {	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), 
									((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)),
									((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)),((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))};
const uint16_t GPIO_PIN[12] = {	((uint16_t)0x0100), 		((uint16_t)0x0080), 		((uint16_t)0x0040), 		((uint16_t)0x0080), 
									((uint16_t)0x0100), 		((uint16_t)0x0200),		((uint16_t)0x0400), 		((uint16_t)0x0800),
									((uint16_t)0x0080), 		((uint16_t)0x0400),      ((uint16_t)0x0800),      ((uint16_t)0x1000)};
const uint32_t GPIO_CLK[12] = {	((uint32_t)0x00000001), 	((uint32_t)0x00000001), 	((uint32_t)0x00000001),	((uint32_t)0x00000020), 
									((uint32_t)0x00000020), 	((uint32_t)0x00000020),	((uint32_t)0x00000020), 	((uint32_t)0x00000020),
									((uint32_t)0x00000001),	((uint32_t)0x00000004), ((uint32_t)0x00000004), ((uint32_t)0x00000004)};


USART_TypeDef* COM_USART[2] = {((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)), ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))}; 

GPIO_TypeDef* COM_TX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))};
 
GPIO_TypeDef* COM_RX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))};

const uint32_t COM_USART_CLK[2] = {((uint32_t)0x00000020), ((uint32_t)0x00000010)};

const uint32_t COM_TX_PORT_CLK[2] = {((uint32_t)0x00000004), ((uint32_t)0x00000001)};
 
const uint32_t COM_RX_PORT_CLK[2] = {((uint32_t)0x00000004), ((uint32_t)0x00000001)};

const uint16_t COM_TX_PIN[2] = {((uint16_t)0x0040), ((uint16_t)0x0200)};

const uint16_t COM_RX_PIN[2] = {((uint16_t)0x0080), ((uint16_t)0x0400)};
 
const uint8_t COM_TX_PIN_SOURCE[2] = {((uint8_t)0x06), ((uint8_t)0x09)};

const uint8_t COM_RX_PIN_SOURCE[2] = {((uint8_t)0x07), ((uint8_t)0x0A)};
 
const uint8_t COM_TX_AF[2] = {((uint8_t)0x08), ((uint8_t)0x07)};
 
const uint8_t COM_RX_AF[2] = {((uint8_t)0x08), ((uint8_t)0x07)};

const uint8_t COM_IRQn[2] = {USART6_IRQn, USART1_IRQn};

const uint32_t USART_DATA_REG_ADDR[2] = {(((((uint32_t)0x40000000) + 0x00010000) + 0x1400) + 0x04), (((((uint32_t)0x40000000) + 0x00010000) + 0x1000) + 0x04)}; 
...
void STM_EVAL_COMInit(COM_TypeDef COM, USART_InitTypeDef* USART_InitStruct, USART_BufDef *USART_BufStruct)
{
	...
	USART_ClearITPendingBit(COM_USART[COM], ((uint16_t)0x0626));
	...
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x00000010), ENABLE);
	DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x28000000));
...
void F205_UsartDMAConfig(COM_TypeDef COM, USART_BufDef *USART_BufStruct)
{
	...
	volatile uint32_t    Timeout = 10000;
  	...
  	DMA_DeInit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)));
	...
	while (DMA_GetCmdStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8))) != DISABLE){}
	...
	DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&(USART_BufStruct->TxBuf[0]);
  	...
  	DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), &DMA_InitStructure);

	
	USART_DMACmd(COM_USART[COM], ((uint16_t)0x0080), ENABLE);
	 
	
  	DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), DISABLE);
}
...
void F205_DisablePeripherals(COM_TypeDef COM)
{
	NVIC_InitTypeDef NVIC_InitStructure;
  	...
  	USART_ITConfig(COM_USART[COM], ((uint16_t)0x0626), 	DISABLE);
	USART_ITConfig(COM_USART[COM], ((uint16_t)0x0525), 	DISABLE);
	USART_ITConfig(COM_USART[COM], ((uint16_t)0x0360),	DISABLE);

	
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x00000080), DISABLE);
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x00000010), DISABLE);
	...
	NVIC_InitStructure.NVIC_IRQChannel = COM_IRQn[COM]; 
  	...
  	RCC_AHB1PeriphClockCmd(((uint32_t)0x00400000), DISABLE);
