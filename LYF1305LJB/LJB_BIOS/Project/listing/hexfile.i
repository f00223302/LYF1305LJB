...
#line 10 "..\\src\\HexFile\\HexFile.c"
#line 11 "..\\src\\HexFile\\HexFile.c"
				...
				switch (HexBuf->actual_len){
					...
					default:
						if (HexBuf->actual_len >= (HexBuf->line_len << 1) + 10)
							return (ret | (1<<6));
						else if (HexBuf->actual_len == (HexBuf->line_len << 1) + 8)
							HexBuf->sum = (data << 4);
						else if (HexBuf->actual_len == (HexBuf->line_len << 1) + 9){
