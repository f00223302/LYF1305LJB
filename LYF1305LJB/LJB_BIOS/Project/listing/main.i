...
#line 1 "..\\src\\SYSTICK\\F205_SysTick.h"
...
#line 13 "..\\src\\SYSTICK\\F205_SysTick.h"

void F205_ConfigSysTick(volatile uint32_t tick);
...
extern void F205_InitLED(void);
extern void F205_PowOnLedFlash(void);
extern void F205_BiosLed(void);
...
int main()
{
	...
	if (*(volatile uint32_t*)((uint32_t)0x20017FFC) == 0x73625593)
	{
		*(volatile uint32_t*)((uint32_t)0x20017FFC) = 0x00000000;
		res = 1;
	}
	else
	{
	...
	if (((*(volatile uint32_t*)(uint32_t)0x08010000) & 0x2FFE0000) == 0x20000000)
	{
...
void GetParams(void)
{
	...
	if ((crc != tmp) || (ParamBuf[0] != 0x61) || (ParamBuf[1] != 0x41) || 		(ParamBuf[2] != 0x73) || (ParamBuf[3] != 0x86) || 		(ParamBuf[4] != 0x10) || (ParamBuf[5] != 0x00) || 		(ParamBuf[6] != 0x20) || (ParamBuf[7] != 0x13) || 		(ParamBuf[8] != 0x10) || (ParamBuf[9] != 0x10))
