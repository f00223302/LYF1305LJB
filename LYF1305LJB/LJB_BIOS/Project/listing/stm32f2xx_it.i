...
#line 39 "..\\src\\stm32f2xx_it.c"
#line 40 "..\\src\\stm32f2xx_it.c"
...
#line 41 "..\\src\\stm32f2xx_it.c"


extern void F205_SysTickFunc(void);


volatile uint16_t USART_RxIndex = 0;
...
void USART6_IRQHandler(void)
{
	...
	if (status & 0x28){
		...
		
		{
			...
			USART_tmpRxBuf[USART_RxIndex] = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))) & 0xff;
			USART_RxIndex++;
			USART_RxIndex &= (0x8000 - 1);
		}
	}
...
void DMA2_Stream7_IRQHandler(void)
{
	...
	if (status & 0x08000000){
		...
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x28008000));
		
	}

	
	if (status & 0x02000000)
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x22000000));	

	
	if (status & 0x00400000)
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x20400000));
}
